...
| ------------- | ------------------------ | -------------------- | ---------------------- |
| `helloworld`  | 1.2168                   | 4.2797               | 27.0909                |
| `quicksort`   | 1.3427                   | 1.3641               | 49.2958                |
| `matrixmulti` | 1.2254                   | 1.2388               | 39.0974                |
| `ackermann`   | 1.2060                   | 1.2112               | 39.2194                |
...
| :----------------------- | ----- | :------ | :-------: | -------- | ---- |
| 01-mcf-gem5-xcg.trace    | L1    | 3       | 0.200455  | 11.30672 |      |
|                          | L2    | 10      | 0.396080  |          |      |
|                          | Mem   | 100     |     x     |          |      |
| 02-stream-gem5-xaa.trace | L1    | 3       | 0.113404  | 11.44584 |      |
|                          | L2    | 10      | 0.755171  |          |      |
|                          | Mem   | 100     |     x     |          |      |

其中AMAT计算公式为
$$
AMAT1 = (1-0.200455)*3+0.200455*[(1-0.396080)*8+0.396080*100]=11.30672\\
AMAT2 = (1-0.113404)*3+0.113404*[(1-0.755171)*8+0.755171*100]=11.44584
$$
